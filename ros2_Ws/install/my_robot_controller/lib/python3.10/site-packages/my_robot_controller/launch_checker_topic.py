...
topic_list = ['/camera/camera/accel/imu_info','/camera/camera/accel/sample','/camera/camera/depth/camera_info','/camera/camera/depth/image_rect_raw','/camera/camera/depth/metadata','/camera/camera/accel/metadata',
