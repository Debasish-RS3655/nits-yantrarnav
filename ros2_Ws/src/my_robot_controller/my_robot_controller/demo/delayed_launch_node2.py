...
class DelayedPublisher(Node):
    def __init__(self):
        super().__init__('delayed_publisher2')
        self.publisher_ = self.create_publisher(String, '/delayed_topic2', 10)
    ...
    def timer_callback(self):
        ...
        self.get_logger().info('Published delayed message to /delayed_topic2')
